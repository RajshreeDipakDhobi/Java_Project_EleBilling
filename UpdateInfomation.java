...
public class UpdateInfomation extends JFrame implements ActionListener
{
    ...
    UpdateInfomation(String meter)
    {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("electricity icon/update.jpg.png"));
    ...
    public void actionPerformed(ActionEvent ae)
     {
        if(ae.getSource() == update)
        {
            ...
            {
                Conn c = new Conn();
                c.s.executeUpdate("update customers set address = '"+address+"',city = '"+city+"',state = '"+state+"',email = '"+email+"', phone = '"+phone+"' where meter_no = '"+meter+"'");
                JOptionPane.showMessageDialog(null, "User Information Uodated Successfully...");
                setVisible(false);
            }
            catch(Exception e)
            {
