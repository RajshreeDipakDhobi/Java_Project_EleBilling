...
public class GenerateBill extends JFrame implements ActionListener
{
    ...
    GenerateBill(String meter)
    {
       ...
       cmonth = new Choice();
          ...
          area.setFont(new Font("Senserit",Font.ITALIC,18));
    ...
    public void actionPerformed(ActionEvent ae)
    {
        try
        {
            ...
            rs = c.s.executeQuery("select * from billcal where meter_no = '"+meter+"' and month = '"+month+"'");
            if(rs.next())
            {
                area.append("\n");
