...
public class PayBill extends JFrame implements ActionListener
{
    ...
    PayBill(String meter)
    {
      ...
      try
      {
          ...
          rs = c.s.executeQuery("select * from billcal where meter_no = '"+meter+"' and month = '"+cmonth.getSelectedItem()+"'");
          while(rs.next())
          {
            ...
            try
      {
          ...
          ResultSet rs = c.s.executeQuery("select * from billcal where meter_no = '"+meter+"' and month = '"+cmonth.getSelectedItem()+"'");
          while(rs.next())
          {
              labelunits.setText(rs.getString("units"));
              labeltotal.setText(rs.getString("totalbill"));
      ...
      add(back);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("electricity icon/bill.png"));
    ...
    public void actionPerformed(ActionEvent ae)
    {
        if(ae.getSource() == pay)
        {
          ...
          {
             Conn c = new Conn();
             c.s.executeUpdate("update billcal set status = 'Paid' where meter_no = '"+meter+"' and month = '"+cmonth.getSelectedItem()+"'");
          }
          catch(Exception e)
          {
              e.printStackTrace();
