...
public class Login extends JFrame implements ActionListener
{
    ...
    super("Login Page");
      ...
      ImageIcon i3 = new ImageIcon(ClassLoader.getSystemResource("electricity icon/cancel.jpg"));
      ...
      ImageIcon i5 = new ImageIcon(ClassLoader.getSystemResource("electricity icon/signup.png"));
      ...
      ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("electricity icon/second.jpg"));
